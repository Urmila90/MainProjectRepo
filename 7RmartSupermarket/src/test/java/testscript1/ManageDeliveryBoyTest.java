...
public class ManageDeliveryBoyTest extends Base {
		...
		public void DeliveryBoyCreation() throws IOException {
			...
			boolean listDeliveryBoy=deliveryboypage.verifyListDeliveryBoyPageIsDisplayed();
			...
			boolean deliveryboyCreatedSuccessMessage=deliveryboypage.isSuccessAlertDisplayedOnSuccessfulDeliveryBoyAddition();
